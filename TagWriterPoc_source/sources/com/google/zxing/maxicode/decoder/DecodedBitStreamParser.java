...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f32FS = '\u001c';

    /* renamed from: GS */
    private static final char f33GS = '\u001d';
    ...
    /* renamed from: NS */
    private static final char f34NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f35RS = '\u001e';
        ...
        switch (mode) {
            ...
            case 3:
                ...
                if (!result.toString().startsWith("[)>\u001e01\u001d")) {
                    result.insert(0, postcode + f33GS + country + f33GS + service + f33GS);
                    break;
                } else {
                    result.insert(9, postcode + f33GS + country + f33GS + service + f33GS);
                    break;
                }
            case 4:
