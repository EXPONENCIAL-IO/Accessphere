...
final class DecodedBitStreamParser {
    ...
    static DecoderResult decode(byte[] bytes, Version version, ErrorCorrectionLevel ecLevel, Map<DecodeHintType, ?> hints) throws FormatException {
                ...
                if (mode != Mode.TERMINATOR) {
                    if (mode == Mode.FNC1_FIRST_POSITION || mode == Mode.FNC1_SECOND_POSITION) {
                        ...
                        if (mode == Mode.NUMERIC) {
                            ...
                            decodeByteSegment(bits, result, count, currentCharacterSetECI, arrayList2, hints);
        ...
        return new DecoderResult(bytes, sb, arrayList, errorCorrectionLevel, symbolSequence, parityData);
    }
