...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0004R.styleable.TextInputLayout, defStyleAttr, C0004R.style.Widget_Design_TextInputLayout);
    ...
    private void updateEditTextBackground() {
        if (this.mErrorShown && this.mErrorView != null) {
            ...
            ViewCompat.setBackgroundTintList(this.mEditText, TintManager.get(getContext()).getTintList(C0004R.C0005drawable.abc_edit_text_material));
        } else {
