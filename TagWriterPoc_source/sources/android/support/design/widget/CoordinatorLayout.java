...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0004R.styleable.CoordinatorLayout_LayoutParams);
            this.gravity = a.getInteger(C0004R.styleable.CoordinatorLayout_LayoutParams_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0004R.styleable.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0004R.styleable.CoordinatorLayout_LayoutParams_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0004R.styleable.CoordinatorLayout_LayoutParams_layout_keyline, -1);
            this.mBehaviorResolved = a.hasValue(C0004R.styleable.CoordinatorLayout_LayoutParams_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0004R.styleable.CoordinatorLayout_LayoutParams_layout_behavior));
            }
            a.recycle();
        }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        /*
            ...
            r11 = 0
            r10 = 0
            int r8 = android.support.p001v4.view.MotionEventCompat.getActionMasked(r15)
