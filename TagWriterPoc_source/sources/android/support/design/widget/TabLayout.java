...
public class TabLayout extends HorizontalScrollView {
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
            ...
            event.setClassName(android.support.p004v7.app.ActionBar.Tab.class.getName());
        }

        @TargetApi(14)
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            super.onInitializeAccessibilityNodeInfo(info);
            info.setClassName(android.support.p004v7.app.ActionBar.Tab.class.getName());
        }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0004R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0004R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0004R.styleable.TextAppearance_android_textColor);
            ta.recycle();
