...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, C0004R.styleable.CollapsingAppBarLayout_LayoutParams);
            this.mCollapseMode = a.getInt(C0004R.styleable.CollapsingAppBarLayout_LayoutParams_layout_collapseMode, 0);
            setParallaxMultiplier(a.getFloat(C0004R.styleable.f4xad49a364, DEFAULT_PARALLAX_MULTIPLIER));
            a.recycle();
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0004R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart)) {
            int marginStart = a.getDimensionPixelSize(C0004R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart, 0);
            if (isRtl) {
        ...
        if (a.hasValue(C0004R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd)) {
            int marginEnd = a.getDimensionPixelSize(C0004R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd, 0);
            if (isRtl) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0004R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
