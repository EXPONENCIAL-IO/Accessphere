...
public class FloatingActionButton extends ImageButton {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mBackgroundTintMode = parseTintMode(a.getInt(C0004R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = a.getColor(C0004R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = a.getInt(C0004R.styleable.FloatingActionButton_fabSize, 0);
        ...
        this.mContentPadding = (getSizeDimension() - ((int) getResources().getDimension(C0004R.dimen.design_fab_content_size))) / 2;
    ...
    public final int getSizeDimension() {
        switch (this.mSize) {
            case 1:
                return getResources().getDimensionPixelSize(C0004R.dimen.design_fab_size_mini);
            default:
                return getResources().getDimensionPixelSize(C0004R.dimen.design_fab_size_normal);
        }
    }
