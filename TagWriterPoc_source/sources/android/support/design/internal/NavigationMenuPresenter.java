...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public void initForMenu(Context context, MenuBuilder menu) {
        ...
        this.mPaddingTopDefault = res.getDimensionPixelOffset(C0004R.dimen.design_navigation_padding_top_default);
        this.mPaddingSeparator = res.getDimensionPixelOffset(C0004R.dimen.design_navigation_separator_vertical_padding);
    }
