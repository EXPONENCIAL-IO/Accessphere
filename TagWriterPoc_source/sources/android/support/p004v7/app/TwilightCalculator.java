...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f18C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f19C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f20C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f21J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long time, double latiude, double longitude) {
        ...
        double solarTransitJ2000 = ((double) (f21J0 + ((float) Math.round(((double) (daysSince2000 - f21J0)) - arcLongitude)))) + arcLongitude + (0.0053d * Math.sin((double) meanAnomaly)) + (-0.0069d * Math.sin(2.0d * solarLng));
