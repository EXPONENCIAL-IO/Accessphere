...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0236R.styleable.AlertDialog, C0236R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0236R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0236R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0236R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0236R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0236R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0236R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    }
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0236R.C0238id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0236R.C0238id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0236R.C0238id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0236R.C0238id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0236R.C0238id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0236R.C0238id.topPanel);
        View customContentPanel = customPanel.findViewById(C0236R.C0238id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0236R.C0238id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null) {
            View spacer = contentPanel.findViewById(C0236R.C0238id.textSpacerNoButtons);
            if (spacer != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0236R.C0238id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0236R.C0238id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0236R.C0238id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0236R.C0238id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0236R.C0238id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0236R.C0238id.scrollView);
