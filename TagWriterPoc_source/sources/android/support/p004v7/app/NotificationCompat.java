...
public class NotificationCompat extends android.support.p001v4.app.NotificationCompat {
    ...
    private static class IceCreamSandwichExtender extends BuilderExtender {
        ...
        public Notification build(android.support.p001v4.app.NotificationCompat.Builder b, NotificationBuilderWithBuilderAccessor builder) {
    ...
    /* access modifiers changed from: private */
    public static void addMediaStyleToBuilderIcs(NotificationBuilderWithBuilderAccessor builder, android.support.p001v4.app.NotificationCompat.Builder b) {
    ...
    /* access modifiers changed from: private */
    public static void addBigMediaStyleToBuilderJellybean(Notification n, android.support.p001v4.app.NotificationCompat.Builder b) {
        if (b.mStyle instanceof MediaStyle) {
            MediaStyle mediaStyle = (MediaStyle) b.mStyle;
