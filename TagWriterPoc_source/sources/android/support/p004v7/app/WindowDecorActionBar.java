...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        boolean homeAsUp;
        boolean z;
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0236R.C0238id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0236R.C0238id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0236R.C0238id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0236R.C0238id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0236R.styleable.ActionBar, C0236R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0236R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0236R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0236R.attr.actionBarWidgetTheme, outValue, true);
