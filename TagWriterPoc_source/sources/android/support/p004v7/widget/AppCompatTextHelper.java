...
class AppCompatTextHelper {
    private static final int[] TEXT_APPEARANCE_ATTRS = {C0236R.attr.textAllCaps};
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        if (ap != -1) {
            TypedArray appearance = context.obtainStyledAttributes(ap, C0236R.styleable.TextAppearance);
            if (appearance.hasValue(C0236R.styleable.TextAppearance_textAllCaps)) {
                setAllCaps(appearance.getBoolean(C0236R.styleable.TextAppearance_textAllCaps, false));
            }
            appearance.recycle();
        }
