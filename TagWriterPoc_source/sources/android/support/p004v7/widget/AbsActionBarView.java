...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0236R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0236R.styleable.ActionBar, C0236R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0236R.styleable.ActionBar_height, 0));
        a.recycle();
