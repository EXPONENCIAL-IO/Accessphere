...
public class Toolbar extends ViewGroup {
    ...
    public static class LayoutParams extends android.support.p004v7.app.ActionBar.LayoutParams {
        ...
        public LayoutParams(LayoutParams source) {
            super((android.support.p004v7.app.ActionBar.LayoutParams) source);
            this.mViewType = 0;
            this.mViewType = source.mViewType;
        }

        public LayoutParams(android.support.p004v7.app.ActionBar.LayoutParams source) {
            super(source);
            this.mViewType = 0;
        }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        C03111 r0 = new android.support.p004v7.widget.ActionMenuView.OnMenuItemClickListener() {
        ...
        int dimensionPixelOffset = a.getDimensionPixelOffset(C0236R.styleable.Toolbar_titleMargins, 0);
        ...
        int contentInsetStart = a.getDimensionPixelOffset(C0236R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0236R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        this.mContentInsets.setAbsolute(a.getDimensionPixelSize(C0236R.styleable.Toolbar_contentInsetLeft, 0), a.getDimensionPixelSize(C0236R.styleable.Toolbar_contentInsetRight, 0));
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new ImageButton(getContext(), null, C0236R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new ImageButton(getContext(), null, C0236R.attr.toolbarNavigationButtonStyle);
    ...
    public LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams p) {
        ...
        if (p instanceof android.support.p004v7.app.ActionBar.LayoutParams) {
            return new LayoutParams((android.support.p004v7.app.ActionBar.LayoutParams) p);
        }
