...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0236R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0236R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0236R.styleable.Spinner, defStyleAttr, 0);
        ...
        if (popupTheme != null) {
            ...
            int popupThemeResId = a.getResourceId(C0236R.styleable.Spinner_popupTheme, 0);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == 1) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0236R.styleable.Spinner, defStyleAttr, 0);
                this.mDropDownWidth = pa.getLayoutDimension(C0236R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C0236R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C0236R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
