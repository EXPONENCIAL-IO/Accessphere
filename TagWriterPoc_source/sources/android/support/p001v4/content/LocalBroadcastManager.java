...
public class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(android.content.Intent r18) {
        ...
        L_0x0090:
            ...
            android.support.v4.content.LocalBroadcastManager$ReceiverRecord r13 = (android.support.p001v4.content.LocalBroadcastManager.ReceiverRecord) r13     // Catch:{ all -> 0x010b }
        ...
        L_0x013f:
            ...
            android.support.v4.content.LocalBroadcastManager$ReceiverRecord r1 = (android.support.p001v4.content.LocalBroadcastManager.ReceiverRecord) r1     // Catch:{ all -> 0x010b }
            r7 = 0
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x002a, code lost:
        ((android.support.p001v4.content.LocalBroadcastManager.ReceiverRecord) r1.receivers.get(r4)).receiver.onReceive(r8.mAppContext, r1.intent);
        r4 = r4 + 1;
     */
    ...
    public void executePendingBroadcasts() {
        ...
        L_0x0000:
            ...
            return
        L_0x000e:
            android.support.v4.content.LocalBroadcastManager$BroadcastRecord[] r2 = new android.support.p001v4.content.LocalBroadcastManager.BroadcastRecord[r0]     // Catch:{ all -> 0x003e }
            java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$BroadcastRecord> r5 = r8.mPendingBroadcasts     // Catch:{ all -> 0x003e }
