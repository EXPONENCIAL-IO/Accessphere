...
public class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = 0, mo33to = 255) int r, @IntRange(from = 0, mo33to = 255) int g, @IntRange(from = 0, mo33to = 255) int b, @NonNull float[] hsl) {
        float h;
        float s;
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int color, @IntRange(from = 0, mo33to = 255) int alpha) {
