...
public class FingerprintManagerCompat {
    ...
    private static class Api23FingerprintManagerCompatImpl implements FingerprintManagerCompatImpl {
        ...
        public static CryptoObject unwrapCryptoObject(android.support.p001v4.hardware.fingerprint.FingerprintManagerCompatApi23.CryptoObject cryptoObject) {
            if (cryptoObject == null) {
                return null;
            }
            if (cryptoObject.getCipher() != null) {
        ...
        private static android.support.p001v4.hardware.fingerprint.FingerprintManagerCompatApi23.AuthenticationCallback wrapCallback(final AuthenticationCallback callback) {
