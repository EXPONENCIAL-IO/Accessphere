...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements DeathRecipient {
        ...
        private class StubApi21 implements android.support.p001v4.media.session.MediaControllerCompatApi21.Callback {
            private StubApi21() {
            }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            if (volumeInfoObj != null) {
                return new PlaybackInfo(android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getPlaybackType(volumeInfoObj), android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getLegacyAudioStream(volumeInfoObj), android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getVolumeControl(volumeInfoObj), android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getMaxVolume(volumeInfoObj), android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getCurrentVolume(volumeInfoObj));
            }
            return null;
        }
    ...
    static class TransportControlsApi21 extends TransportControls {
        ...
        public void seekTo(long pos) {
            android.support.p001v4.media.session.MediaControllerCompatApi21.TransportControls.seekTo(this.mControlsObj, pos);
        }
        ...
        public void setRating(RatingCompat rating) {
            android.support.p001v4.media.session.MediaControllerCompatApi21.TransportControls.setRating(this.mControlsObj, rating != null ? rating.getRating() : null);
        }

        public void playFromMediaId(String mediaId, Bundle extras) {
            android.support.p001v4.media.session.MediaControllerCompatApi21.TransportControls.playFromMediaId(this.mControlsObj, mediaId, extras);
        }

        public void playFromSearch(String query, Bundle extras) {
            android.support.p001v4.media.session.MediaControllerCompatApi21.TransportControls.playFromSearch(this.mControlsObj, query, extras);
        }
        ...
        public void skipToQueueItem(long id) {
            android.support.p001v4.media.session.MediaControllerCompatApi21.TransportControls.skipToQueueItem(this.mControlsObj, id);
        }

        public void sendCustomAction(CustomAction customAction, Bundle args) {
            android.support.p001v4.media.session.MediaControllerCompatApi21.TransportControls.sendCustomAction(this.mControlsObj, customAction.getAction(), args);
        }

        public void sendCustomAction(String action, Bundle args) {
            android.support.p001v4.media.session.MediaControllerCompatApi21.TransportControls.sendCustomAction(this.mControlsObj, action, args);
        }
    }
    ...
    static class TransportControlsApi23 extends TransportControlsApi21 {
        ...
        public void playFromUri(Uri uri, Bundle extras) {
            android.support.p001v4.media.session.MediaControllerCompatApi23.TransportControls.playFromUri(this.mControlsObj, uri, extras);
        }
    }
