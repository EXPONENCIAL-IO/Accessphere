...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        android.support.p001v4.media.MediaDescriptionCompat.Builder bob = new android.support.p001v4.media.MediaDescriptionCompat.Builder();
    ...
    public Object getMediaMetadata() {
        ...
        Object builderObj = android.support.p001v4.media.MediaMetadataCompatApi21.Builder.newInstance();
        for (String key : keySet()) {
            Integer type = (Integer) METADATA_KEYS_TYPE.get(key);
            if (type != null) {
                switch (type.intValue()) {
                    case 0:
                        android.support.p001v4.media.MediaMetadataCompatApi21.Builder.putLong(builderObj, key, getLong(key));
                        break;
                    case 1:
                        android.support.p001v4.media.MediaMetadataCompatApi21.Builder.putText(builderObj, key, getText(key));
                        break;
                    case 2:
                        android.support.p001v4.media.MediaMetadataCompatApi21.Builder.putBitmap(builderObj, key, getBitmap(key));
                        break;
                    case 3:
                        android.support.p001v4.media.MediaMetadataCompatApi21.Builder.putRating(builderObj, key, getRating(key).getRating());
                        break;
                }
            }
        }
        this.mMetadataObj = android.support.p001v4.media.MediaMetadataCompatApi21.Builder.build(builderObj);
        return this.mMetadataObj;
    }
}
