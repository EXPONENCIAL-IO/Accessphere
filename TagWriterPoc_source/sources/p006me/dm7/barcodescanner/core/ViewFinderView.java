...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultBorderColor = getResources().getColor(C0339R.color.viewfinder_border);
    private final int mDefaultBorderLineLength = getResources().getInteger(C0339R.integer.viewfinder_border_length);
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(C0339R.integer.viewfinder_border_width);
    private final int mDefaultLaserColor = getResources().getColor(C0339R.color.viewfinder_laser);
    private final int mDefaultMaskColor = getResources().getColor(C0339R.color.viewfinder_mask);
    ...
    public synchronized void updateFramingRect() {
        ...
        if (DisplayUtils.getScreenOrientation(getContext()) != 1) {
            width = findDesiredDimensionInRange(0.625f, viewResolution.x, 240, LANDSCAPE_MAX_FRAME_WIDTH);
            height = findDesiredDimensionInRange(0.625f, viewResolution.y, 240, LANDSCAPE_MAX_FRAME_HEIGHT);
        } else {
            width = findDesiredDimensionInRange(PORTRAIT_WIDTH_RATIO, viewResolution.x, 240, PORTRAIT_MAX_FRAME_WIDTH);
            height = findDesiredDimensionInRange(PORTRAIT_HEIGHT_RATIO, viewResolution.y, 240, PORTRAIT_MAX_FRAME_HEIGHT);
        }
