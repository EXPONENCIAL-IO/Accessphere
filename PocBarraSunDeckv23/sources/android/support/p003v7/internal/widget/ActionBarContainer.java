...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        if (getId() == C0140R.C0142id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0140R.C0142id.action_bar);
        this.mContextView = findViewById(C0140R.C0142id.action_context_bar);
    }
