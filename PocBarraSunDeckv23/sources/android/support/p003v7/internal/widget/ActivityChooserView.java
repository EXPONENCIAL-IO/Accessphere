...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case 0:
                    if (convertView == null || convertView.getId() != C0140R.C0142id.list_item) {
                    ...
                    ((ImageView) convertView.findViewById(C0140R.C0142id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0140R.C0142id.title)).setText(activity.loadLabel(packageManager));
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0140R.layout.abc_activity_chooser_view_list_item, parent, false);
                        convertView.setId(1);
                        ((TextView) convertView.findViewById(C0140R.C0142id.title)).setText(ActivityChooserView.this.getContext().getString(C0140R.string.abc_activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0140R.C0142id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0140R.C0142id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0140R.C0142id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0140R.C0142id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(C0140R.C0142id.image);
