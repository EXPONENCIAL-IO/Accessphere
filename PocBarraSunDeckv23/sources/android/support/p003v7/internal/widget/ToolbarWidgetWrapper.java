...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    /* access modifiers changed from: private */
    public WindowCallback mWindowCallback;

    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C0140R.string.abc_action_bar_up_description, C0140R.C0141drawable.abc_ic_ab_back_mtrl_am_alpha);
    }
    ...
    public void setMenu(Menu menu, Callback cb) {
        if (this.mActionMenuPresenter == null) {
            ...
            this.mActionMenuPresenter.setId(C0140R.C0142id.action_menu_presenter);
        }
    ...
    private void ensureSpinner() {
        if (this.mSpinner == null) {
            this.mSpinner = new SpinnerCompat(getContext(), null, C0140R.attr.actionDropDownStyle);
