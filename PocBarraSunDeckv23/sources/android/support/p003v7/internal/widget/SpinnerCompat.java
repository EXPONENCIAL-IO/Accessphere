...
class SpinnerCompat extends AbsSpinnerCompat implements OnClickListener {
    ...
    SpinnerCompat(Context context, AttributeSet attrs, int defStyle, int mode) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0140R.styleable.Spinner, defStyle, 0);
        setBackgroundDrawable(a.getDrawable(C0140R.styleable.Spinner_android_background));
        if (mode == -1) {
            mode = a.getInt(C0140R.styleable.Spinner_spinnerMode, 0);
        }
        switch (mode) {
            case 0:
            ...
            case 1:
                ...
                this.mDropDownWidth = a.getLayoutDimension(C0140R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(a.getDrawable(C0140R.styleable.Spinner_android_popupBackground));
                this.mPopup = popup;
        ...
        this.mGravity = a.getInt(C0140R.styleable.Spinner_android_gravity, 17);
        this.mPopup.setPromptText(a.getString(C0140R.styleable.Spinner_prompt));
        this.mDisableChildrenWhenDisabled = a.getBoolean(C0140R.styleable.Spinner_disableChildrenWhenDisabled, false);
        a.recycle();
