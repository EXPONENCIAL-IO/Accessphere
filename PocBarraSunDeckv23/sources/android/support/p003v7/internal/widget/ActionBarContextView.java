...
public class ActionBarContextView extends AbsActionBarView implements ViewPropertyAnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mSplitBackground = a.getDrawable(C0140R.styleable.ActionMode_backgroundSplit);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0140R.C0142id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0140R.C0142id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mClose.findViewById(C0140R.C0142id.action_mode_close_button).setOnClickListener(new OnClickListener() {
