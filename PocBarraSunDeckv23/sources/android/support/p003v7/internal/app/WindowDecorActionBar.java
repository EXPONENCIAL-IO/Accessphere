...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ...
        boolean homeAsUp;
        boolean z;
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0140R.C0142id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0140R.C0142id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0140R.C0142id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0140R.C0142id.action_bar_container);
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0140R.C0142id.split_action_bar);
