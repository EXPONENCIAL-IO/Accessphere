...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = 0;
            TypedArray a = c.obtainStyledAttributes(attrs, C0140R.styleable.ActionBarLayout);
            this.gravity = a.getInt(C0140R.styleable.ActionBarLayout_android_layout_gravity, 0);
            a.recycle();
        }
    ...
    public ActionMode startActionMode(android.support.p003v7.view.ActionMode.Callback callback) {
        return null;
    }
