...
import android.support.p003v7.internal.widget.TintAutoCompleteTextView;
import android.support.p003v7.internal.widget.TintButton;
import android.support.p003v7.internal.widget.TintCheckBox;
import android.support.p003v7.internal.widget.TintCheckedTextView;
import android.support.p003v7.internal.widget.TintEditText;
import android.support.p003v7.internal.widget.TintManager;
import android.support.p003v7.internal.widget.TintMultiAutoCompleteTextView;
import android.support.p003v7.internal.widget.TintRadioButton;
import android.support.p003v7.internal.widget.TintRatingBar;
import android.support.p003v7.internal.widget.TintSpinner;
...
class ActionBarActivityDelegateBase extends ActionBarActivityDelegate implements Callback {
    ...
    /* renamed from: android.support.v7.app.ActionBarActivityDelegateBase$ActionMenuPresenterCallback */
    ...
    /* renamed from: android.support.v7.app.ActionBarActivityDelegateBase$ListMenuDecorView */
    ...
    /* renamed from: android.support.v7.app.ActionBarActivityDelegateBase$PanelFeatureState */
    private static final class PanelFeatureState {
        ...
        /* renamed from: android.support.v7.app.ActionBarActivityDelegateBase$PanelFeatureState$SavedState */
    ...
    /* renamed from: android.support.v7.app.ActionBarActivityDelegateBase$PanelMenuPresenterCallback */
    ...
    public final void ensureSubDecor() {
        ...
        if (!this.mSubDecorInstalled) {
            if (this.mHasActionBar) {
                TypedValue outValue = new TypedValue();
                this.mActivity.getTheme().resolveAttribute(C0140R.attr.actionBarTheme, outValue, true);
                if (outValue.resourceId != 0) {
                    themedContext = new ContextThemeWrapper(this.mActivity, outValue.resourceId);
                } else {
                    themedContext = this.mActivity;
                }
                this.mSubDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0140R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) this.mSubDecor.findViewById(C0140R.C0142id.decor_content_parent);
                ...
                if (this.mOverlayActionMode) {
                    this.mSubDecor = (ViewGroup) LayoutInflater.from(this.mActivity).inflate(C0140R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    this.mSubDecor = (ViewGroup) LayoutInflater.from(this.mActivity).inflate(C0140R.layout.abc_screen_simple, null);
                }
            ...
            ViewGroup abcContent = (ViewGroup) this.mSubDecor.findViewById(C0140R.C0142id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow() {
        ...
        if (a.hasValue(C0140R.styleable.Theme_windowFixedWidthMajor)) {
            ...
            a.getValue(C0140R.styleable.Theme_windowFixedWidthMajor, mFixedWidthMajor);
        }
        if (a.hasValue(C0140R.styleable.Theme_windowFixedWidthMinor)) {
            if (0 == 0) {
                mFixedWidthMinor = new TypedValue();
            }
            a.getValue(C0140R.styleable.Theme_windowFixedWidthMinor, mFixedWidthMinor);
        }
        if (a.hasValue(C0140R.styleable.Theme_windowFixedHeightMajor)) {
            if (0 == 0) {
                mFixedHeightMajor = new TypedValue();
            }
            a.getValue(C0140R.styleable.Theme_windowFixedHeightMajor, mFixedHeightMajor);
        }
        if (a.hasValue(C0140R.styleable.Theme_windowFixedHeightMinor)) {
            if (0 == 0) {
                mFixedHeightMinor = new TypedValue();
            }
            a.getValue(C0140R.styleable.Theme_windowFixedHeightMinor, mFixedHeightMinor);
        }
    ...
    public ActionMode startSupportActionModeFromWindow(ActionMode.Callback callback) {
        ...
        if (this.mActionModeView == null) {
            if (this.mIsFloating) {
                ...
                this.mActionModePopup = new PopupWindow(context, null, C0140R.attr.actionModePopupWindowStyle);
                this.mActionModePopup.setContentView(this.mActionModeView);
                this.mActionModePopup.setWidth(-1);
                TypedValue heightValue = new TypedValue();
                this.mActivity.getTheme().resolveAttribute(C0140R.attr.actionBarSize, heightValue, true);
                ...
                ViewStubCompat stub = (ViewStubCompat) this.mActivity.findViewById(C0140R.C0142id.action_mode_bar_stub);
                if (stub != null) {
    ...
    public int getHomeAsUpIndicatorAttrId() {
        return C0140R.attr.homeAsUpIndicator;
    }
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    st.isHandled = false;
                    WindowManager.LayoutParams lp3 = new WindowManager.LayoutParams(width, -2, st.f9x, st.f10y, 1002, 8519680, -3);
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != newMargin) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mActivity.getResources().getColor(C0140R.color.abc_input_method_navigation_guard));
