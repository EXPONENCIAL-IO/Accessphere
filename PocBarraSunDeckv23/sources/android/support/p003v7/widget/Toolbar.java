...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        C01951 r0 = new android.support.p003v7.widget.ActionMenuView.OnMenuItemClickListener() {
        ...
        this.mMinHeight = a.getDimensionPixelSize(C0140R.styleable.Toolbar_android_minHeight, 0);
        a.recycle();
    ...
    private static Context themifyContext(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0140R.styleable.Toolbar, defStyleAttr, 0);
        int themeId = a.getResourceId(C0140R.styleable.Toolbar_theme, 0);
        if (themeId != 0) {
