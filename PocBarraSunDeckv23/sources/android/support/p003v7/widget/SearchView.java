...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static final boolean IS_AT_LEAST_FROYO;
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(a.getResourceId(C0140R.styleable.SearchView_layout, 0), this, true);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0140R.C0142id.search_src_text);
        this.mQueryTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0140R.C0142id.search_edit_frame);
        this.mSearchPlate = findViewById(C0140R.C0142id.search_plate);
        this.mSubmitArea = findViewById(C0140R.C0142id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0140R.C0142id.search_button);
        this.mSubmitButton = (ImageView) findViewById(C0140R.C0142id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0140R.C0142id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0140R.C0142id.search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0140R.C0142id.search_mag_icon);
        ...
        this.mSearchIconResId = a.getResourceId(C0140R.styleable.SearchView_searchIcon, 0);
        this.mSearchButton.setImageResource(this.mSearchIconResId);
        this.mSubmitButton.setImageDrawable(a.getDrawable(C0140R.styleable.SearchView_goIcon));
        ...
        this.mSearchHintIcon.setImageDrawable(a.getDrawable(C0140R.styleable.SearchView_searchIcon));
        this.mSuggestionRowLayout = a.getResourceId(C0140R.styleable.SearchView_suggestionRowLayout, 0);
        ...
        CharSequence queryHint = a.getText(C0140R.styleable.SearchView_queryHint);
