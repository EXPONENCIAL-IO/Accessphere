...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultBorderColor = getResources().getColor(C0250R.color.viewfinder_border);
    private final int mDefaultBorderLineLength = getResources().getInteger(C0250R.integer.viewfinder_border_length);
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(C0250R.integer.viewfinder_border_width);
    private final int mDefaultLaserColor = getResources().getColor(C0250R.color.viewfinder_laser);
    private final int mDefaultMaskColor = getResources().getColor(C0250R.color.viewfinder_mask);
