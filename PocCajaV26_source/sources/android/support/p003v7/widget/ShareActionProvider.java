...
import android.support.p003v7.internal.widget.ActivityChooserModel.OnChooseActivityListener;
...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(C0190R.attr.actionModeShareDrawable, outTypedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(C0190R.string.abc_shareactionprovider_share_with_application);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(C0190R.string.abc_shareactionprovider_share_with);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (collapsedActivityCount < expandedActivityCount) {
            SubMenu expandedSubMenu = subMenu.addSubMenu(0, collapsedActivityCount, collapsedActivityCount, this.mContext.getString(C0190R.string.abc_activity_chooser_view_see_all));
