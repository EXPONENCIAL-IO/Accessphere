...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0190R.styleable.MenuGroup);
            this.groupId = a.getResourceId(C0190R.styleable.MenuGroup_android_id, 0);
            this.groupCategory = a.getInt(C0190R.styleable.MenuGroup_android_menuCategory, 0);
            this.groupOrder = a.getInt(C0190R.styleable.MenuGroup_android_orderInCategory, 0);
            this.groupCheckable = a.getInt(C0190R.styleable.MenuGroup_android_checkableBehavior, 0);
            this.groupVisible = a.getBoolean(C0190R.styleable.MenuGroup_android_visible, true);
            this.groupEnabled = a.getBoolean(C0190R.styleable.MenuGroup_android_enabled, true);
            a.recycle();
        }

        public void readItem(AttributeSet attrs) {
            int i;
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0190R.styleable.MenuItem);
            this.itemId = a.getResourceId(C0190R.styleable.MenuItem_android_id, 0);
            this.itemCategoryOrder = (-65536 & a.getInt(C0190R.styleable.MenuItem_android_menuCategory, this.groupCategory)) | (65535 & a.getInt(C0190R.styleable.MenuItem_android_orderInCategory, this.groupOrder));
            this.itemTitle = a.getText(C0190R.styleable.MenuItem_android_title);
            this.itemTitleCondensed = a.getText(C0190R.styleable.MenuItem_android_titleCondensed);
            this.itemIconResId = a.getResourceId(C0190R.styleable.MenuItem_android_icon, 0);
            this.itemAlphabeticShortcut = getShortcut(a.getString(C0190R.styleable.MenuItem_android_alphabeticShortcut));
            this.itemNumericShortcut = getShortcut(a.getString(C0190R.styleable.MenuItem_android_numericShortcut));
            if (a.hasValue(C0190R.styleable.MenuItem_android_checkable)) {
                if (a.getBoolean(C0190R.styleable.MenuItem_android_checkable, false)) {
                    i = 1;
                } else {
                    i = 0;
                }
            ...
            this.itemChecked = a.getBoolean(C0190R.styleable.MenuItem_android_checked, false);
            this.itemVisible = a.getBoolean(C0190R.styleable.MenuItem_android_visible, this.groupVisible);
            this.itemEnabled = a.getBoolean(C0190R.styleable.MenuItem_android_enabled, this.groupEnabled);
            this.itemShowAsAction = a.getInt(C0190R.styleable.MenuItem_showAsAction, -1);
            this.itemListenerMethodName = a.getString(C0190R.styleable.MenuItem_android_onClick);
            this.itemActionViewLayout = a.getResourceId(C0190R.styleable.MenuItem_actionLayout, 0);
            this.itemActionViewClassName = a.getString(C0190R.styleable.MenuItem_actionViewClass);
            this.itemActionProviderClassName = a.getString(C0190R.styleable.MenuItem_actionProviderClass);
