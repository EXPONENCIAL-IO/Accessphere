...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0190R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0190R.styleable.ActionBar, C0190R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0190R.styleable.ActionBar_height, 0));
        a.recycle();
