...
class AlertController {
    ...
    public static class AlertParams {
        ...
        /* JADX WARNING: type inference failed for: r0v1, types: [android.support.v7.app.AlertController$CheckedItemAdapter] */
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0190R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0190R.styleable.AlertDialog, C0190R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0190R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0190R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0190R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0190R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0190R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0190R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    }
    ...
    private void setupView() {
        View customView;
        setupContent((ViewGroup) this.mWindow.findViewById(C0190R.C0192id.contentPanel));
        boolean hasButtons = setupButtons();
        ViewGroup topPanel = (ViewGroup) this.mWindow.findViewById(C0190R.C0192id.topPanel);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mContext, null, C0190R.styleable.AlertDialog, C0190R.attr.alertDialogStyle, 0);
        boolean z = setupTitle(topPanel);
        View buttonPanel = this.mWindow.findViewById(C0190R.C0192id.buttonPanel);
        if (!hasButtons) {
            buttonPanel.setVisibility(8);
            View spacer = this.mWindow.findViewById(C0190R.C0192id.textSpacerNoButtons);
            if (spacer != null) {
                spacer.setVisibility(0);
            }
        }
        FrameLayout customPanel = (FrameLayout) this.mWindow.findViewById(C0190R.C0192id.customPanel);
        if (this.mView != null) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0190R.C0192id.custom);
    ...
    private boolean setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0190R.C0192id.title_template).setVisibility(8);
            return true;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0190R.C0192id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (ScrollView) this.mWindow.findViewById(C0190R.C0192id.scrollView);
