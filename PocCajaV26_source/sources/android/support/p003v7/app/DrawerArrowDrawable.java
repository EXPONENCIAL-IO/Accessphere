...
abstract class DrawerArrowDrawable extends Drawable {
    ...
    DrawerArrowDrawable(Context context) {
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(null, C0190R.styleable.DrawerArrowToggle, C0190R.attr.drawerArrowStyle, C0190R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        this.mPaint.setAntiAlias(true);
        this.mPaint.setColor(typedArray.getColor(C0190R.styleable.DrawerArrowToggle_color, 0));
        this.mSize = typedArray.getDimensionPixelSize(C0190R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarSize = (float) Math.round(typedArray.getDimension(C0190R.styleable.DrawerArrowToggle_barSize, 0.0f));
        this.mTopBottomArrowSize = (float) Math.round(typedArray.getDimension(C0190R.styleable.DrawerArrowToggle_topBottomBarArrowSize, 0.0f));
        this.mBarThickness = typedArray.getDimension(C0190R.styleable.DrawerArrowToggle_thickness, 0.0f);
        this.mBarGap = (float) Math.round(typedArray.getDimension(C0190R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f));
        this.mSpin = typedArray.getBoolean(C0190R.styleable.DrawerArrowToggle_spinBars, true);
        this.mMiddleArrowSize = typedArray.getDimension(C0190R.styleable.DrawerArrowToggle_middleBarArrowSize, 0.0f);
