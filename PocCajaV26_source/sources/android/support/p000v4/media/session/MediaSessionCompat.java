...
import android.support.p000v4.media.session.PlaybackStateCompat.Builder;
        ...
        public void setCallback(final Callback callback, Handler handler) {
            if (callback != this.mCallback) {
                if (callback == null || VERSION.SDK_INT < 18) {
                    ...
                    android.support.p000v4.media.session.MediaSessionCompatApi14.Callback cb14 = new android.support.p000v4.media.session.MediaSessionCompatApi14.Callback() {
                        public void onStop() {
                            callback.onStop();
                        }
