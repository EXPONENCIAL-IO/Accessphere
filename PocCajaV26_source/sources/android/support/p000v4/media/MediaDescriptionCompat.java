...
public final class MediaDescriptionCompat implements Parcelable {
    ...
    public Object getMediaDescription() {
        ...
        Object bob = android.support.p000v4.media.MediaDescriptionCompatApi21.Builder.newInstance();
        android.support.p000v4.media.MediaDescriptionCompatApi21.Builder.setMediaId(bob, this.mMediaId);
        android.support.p000v4.media.MediaDescriptionCompatApi21.Builder.setTitle(bob, this.mTitle);
        android.support.p000v4.media.MediaDescriptionCompatApi21.Builder.setSubtitle(bob, this.mSubtitle);
        android.support.p000v4.media.MediaDescriptionCompatApi21.Builder.setDescription(bob, this.mDescription);
        android.support.p000v4.media.MediaDescriptionCompatApi21.Builder.setIconBitmap(bob, this.mIcon);
        android.support.p000v4.media.MediaDescriptionCompatApi21.Builder.setIconUri(bob, this.mIconUri);
        android.support.p000v4.media.MediaDescriptionCompatApi21.Builder.setExtras(bob, this.mExtras);
        if (VERSION.SDK_INT >= 23) {
            Builder.setMediaUri(bob, this.mMediaUri);
        }
        this.mDescriptionObj = android.support.p000v4.media.MediaDescriptionCompatApi21.Builder.build(bob);
        return this.mDescriptionObj;
    }
