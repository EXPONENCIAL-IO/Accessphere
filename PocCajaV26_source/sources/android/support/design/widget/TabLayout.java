...
public class TabLayout extends HorizontalScrollView {
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public final void update() {
            ...
            if (this.mCustomView == null) {
                if (this.mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext()).inflate(C0000R.layout.layout_tab_icon, this, false);
                    addView(iconView, 0);
                    this.mIconView = iconView;
                }
                if (this.mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0000R.layout.layout_tab_text, this, false);
                    addView(textView);
    ...
    private ColorStateList loadTextColorFromTextAppearance(int textAppearanceResId) {
        ...
        try {
            return a.getColorStateList(C0000R.styleable.TextAppearance_android_textColor);
        } finally {
            a.recycle();
        }
    }
