...
final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int resId) {
        ...
        if (a.hasValue(C0000R.styleable.TextAppearance_android_textColor)) {
            this.mCollapsedTextColor = a.getColor(C0000R.styleable.TextAppearance_android_textColor, 0);
        }
        if (a.hasValue(C0000R.styleable.TextAppearance_android_textSize)) {
            this.mCollapsedTextSize = (float) a.getDimensionPixelSize(C0000R.styleable.TextAppearance_android_textSize, 0);
        }
        a.recycle();
        recalculate();
    }
    ...
    public void setExpandedTextAppearance(int resId) {
        TypedArray a = this.mView.getContext().obtainStyledAttributes(resId, C0000R.styleable.TextAppearance);
        if (a.hasValue(C0000R.styleable.TextAppearance_android_textColor)) {
            this.mExpandedTextColor = a.getColor(C0000R.styleable.TextAppearance_android_textColor, 0);
        }
        if (a.hasValue(C0000R.styleable.TextAppearance_android_textSize)) {
            this.mExpandedTextSize = (float) a.getDimensionPixelSize(C0000R.styleable.TextAppearance_android_textSize, 0);
        }
        a.recycle();
        recalculate();
    }
