...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Resources resources, Drawable content, float radius, float shadowSize, float maxShadowSize) {
        super(content);
        this.mShadowStartColor = resources.getColor(C0000R.color.shadow_start_color);
        this.mShadowMiddleColor = resources.getColor(C0000R.color.shadow_mid_color);
        this.mShadowEndColor = resources.getColor(C0000R.color.shadow_end_color);
