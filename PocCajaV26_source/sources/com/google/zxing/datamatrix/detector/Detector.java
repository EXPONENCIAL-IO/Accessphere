...
public final class Detector {
    ...
    private static final class ResultPointsAndTransitions {
        ...
        /* renamed from: to */
        private final ResultPoint f32to;
        ...
        public String toString() {
            return this.from + "/" + this.f32to + '/' + this.transitions;
        }
    }
    ...
    private ResultPointsAndTransitions transitionsBetween(ResultPoint from, ResultPoint to) {
        ...
        ResultPointsAndTransitions resultPointsAndTransitions = new ResultPointsAndTransitions(from, to, transitions);
