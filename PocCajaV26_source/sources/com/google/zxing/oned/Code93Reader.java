...
public final class Code93Reader extends OneDReader {
    ...
    public Result decodeRow(int rowNumber, BitArray row, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        for (int i2 = 0; i2 < theCounters.length; i2++) {
        ...
        if (nextStart == end || !row.get(nextStart)) {
            ...
            ResultPoint resultPoint = new ResultPoint(((float) (start[1] + start[0])) / 2.0f, (float) rowNumber);
            ResultPoint resultPoint2 = new ResultPoint(right, (float) rowNumber);
            Result result2 = new Result(resultString, null, new ResultPoint[]{resultPoint, resultPoint2}, BarcodeFormat.CODE_93);
            return result2;
        }
    }
