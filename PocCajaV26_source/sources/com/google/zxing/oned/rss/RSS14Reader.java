...
public final class RSS14Reader extends AbstractRSSReader {
    ...
    private DataCharacter decodeDataCharacter(BitArray row, FinderPattern pattern, boolean outsideChar) throws NotFoundException {
        ...
        if (outsideChar) {
            ...
            DataCharacter dataCharacter = new DataCharacter((RSSUtils.getRSSvalue(oddCounts, oddWidest, false) * OUTSIDE_EVEN_TOTAL_SUBSET[group]) + RSSUtils.getRSSvalue(evenCounts, evenWidest, true) + OUTSIDE_GSUM[group], checksumPortion);
            ...
            DataCharacter dataCharacter2 = new DataCharacter((RSSUtils.getRSSvalue(evenCounts, 9 - oddWidest2, false) * INSIDE_ODD_TOTAL_SUBSET[group2]) + RSSUtils.getRSSvalue(oddCounts, oddWidest2, true) + INSIDE_GSUM[group2], checksumPortion);
