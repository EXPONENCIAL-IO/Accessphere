...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f33FS = '\u001c';

    /* renamed from: GS */
    private static final char f34GS = '\u001d';
    ...
    /* renamed from: NS */
    private static final char f35NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f36RS = '\u001e';
        ...
        switch (mode) {
            ...
            case 3:
                ...
                if (!result.toString().startsWith("[)>\u001e01\u001d")) {
                    result.insert(0, postcode + f34GS + country + f34GS + service + f34GS);
                    break;
                } else {
                    result.insert(9, postcode + f34GS + country + f34GS + service + f34GS);
                    break;
                }
            case 4:
